...
// 设置缓存名称和文件
const CACHE_NAME = "game-cache-name";
const DATA_BASE_NAME = "game-cache-db";
...
async function clearCaches() {
    ...
    const mendixCacheKeys = cacheKeys.filter((key) =>
...
async function deleteDatabase() {
    return new Promise((resolve, reject) => {
        const req = indexedDB.deleteDatabase(DATA_BASE_NAME);
